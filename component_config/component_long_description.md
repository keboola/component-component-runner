...
- Trigger component runs with dynamic parameters from upstream data
- Create complex orchestration patterns with variable-driven executions
- Run the same component configuration multiple times with different variable values
- Integrate components across different Keboola projects or stacks
